...
public class sailMaker : MonoBehaviour
{
    ...
    private void OnEnable()
    {
        ...
        List<Vector3> clothVerts = new List<Vector3>(dynamics.vertices);

        var edges = EdgeHelpers.FindBoundary(EdgeHelpers.GetEdges(sail.triangles));
        ...
        dynamics.stretchingStiffness = 0;
